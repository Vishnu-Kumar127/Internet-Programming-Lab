					...
					<section id="footer">
						<div class="inner">
							...
							<ul class="contact">
								...
								<li class="icon solid fa-phone">(+91)8124892793</li>
								<li class="icon solid fa-envelope"><a href="https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox?compose=GTvVlcSDZNzTdclqlKJSDglTddJvRMhLVrHnjQmvgffJzQZJWrVwmDnKkxLfpmJgJLNFHVsFbSqSD">mjvishnukumar2003@gmail.com</a></li>
								<li class="icon brands fa-twitter"><a href="https://twitter.com/vishnu04092003">twitter</a></li>
								<li class="icon brands fa-facebook-f"><a href="https://www.facebook.com/vishnu.prince.9250">facebook</a></li>
								<li class="icon brands fa-instagram"><a href="https://www.instagram.com/v.ish.nu_4/">instagram</a></li>
							</ul>
							<ul class="copyright">
								<li>&copy; Online Railway Reservation System.</li><li>Developed By: VISHNU KUMAR, DINESH, VIKRAM GANESH, ARUN KUMAR</li>
							</ul>
						</div>
					</section>
